...
impl Default for UiType {
    fn default() -> UiType {
        UiType {
            curses_impl: Curses::default(),
            opengl_impl: Gl::default(),
        }
    }
}
pub trait NotFound {
...
impl UI for Curses {
    ...
    fn draw_tile(&self, tile: Tile, rel_x: i32, rel_y: i32) {
        if rel_x < 0
            || rel_y < 0
    ...
    fn draw_cursor(&self, y: i32, x: i32) {
